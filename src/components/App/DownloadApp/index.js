      ...
      <div className={styles.block}>
        <div className={styles.blockLeft}>
          <div className={styles.content}>
            ...
            <p>
              Keep your AirDAO assets safe with the official wallet. Stay up to
              date on your portfolio with watchlists, transaction tracking, and
              AMB price alerts. It’s all of AirDAO, in one place.
            </p>
            {data.length > 0 && (
