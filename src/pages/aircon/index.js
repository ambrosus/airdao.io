    ...
    <div className={styles.page}>
      ...
      <div className={styles.heading}>
        <div className={`${styles.container} ${styles.heading__container}`}>
          ...
          />
          <PrismicNextLink
            field={page.heading_register_url}
            className={styles.heading__btn}
          >
            <PrismicRichText
          ...
          {page.heading_socials.map(el => (
            <PrismicNextLink
              key={el.img.url}
              field={el.link}
              className={styles.heading__social}
            >
          ...
          {page.speaker.map(el => (
            <div className={styles.speakers__item} key={asText(el.name)}>
              {el.img.url ? (
                <img
                  src={el.img.url}
                  className={styles.speakers__img}
                  alt="photo"
                />
              ) : (
      ...
      <section className={styles.contact_section}>
        <h2 className={`${styles.title} ${styles.title_contact}`}>
          Contact us
        </h2>
        <p className={styles.subtitle}>
          Get in touch to discover how sponsoring AirCON can benefit your brand:
        </p>
          ...
          <div className={styles.footer__socials}>
            {page.footer_right.map((el, i) => (
              <PrismicNextLink field={el.link} key={i}>
                <img src={el.img.url} alt="aircon img" />
              </PrismicNextLink>
            ))}
          </div>
        </div>
