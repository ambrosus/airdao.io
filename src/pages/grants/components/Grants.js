      ...
      <div className={styles.grantInfo}>
        ...
        <div className={`${styles.infoItem} ${styles.itemD}`}>
          ...
          <div className={styles.infoText}>
            ...
            <p>Push boundaries, be bold. You are the future</p>
          </div>
        </div>
      </div>
        ...
        <div className={styles.tierBlock}>
          <div className={styles.tierList}>
            {Object.values(grantTiers)?.map((card, index) => (
              <div key={index} className={styles.tierItem}>
                <Image src={card.img} alt={card.alt} width={100} height={100} />
          ...
          <div className={styles.ctaBlock}>
            ...
            <p className={styles.ctaText}>
              If you have questions before submitting your project application,
