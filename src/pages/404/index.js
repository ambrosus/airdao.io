  ...
  return (
    <>
      ...
      <div className={styles['not-found']}>
        <Image layout='fill' src={circles} alt='circles' className={styles['not-found__circles']} />
        <Image layout='fill' src={img} alt='not found' className={styles['not-found__img']}/>
        <p className={styles['not-found__text']}>The page you are looking for may have been moved, deleted, or possibly never existed</p>
